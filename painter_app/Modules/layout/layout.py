...
import os
import copy
from .layout_validations import LayoutValidations
...
class Layout:
    ...
    def draw_shape(self):
        ...
        _validations = LayoutValidations(self._max_width, self._max_height)
        _validations.validate_layout(self._width, self._height)
